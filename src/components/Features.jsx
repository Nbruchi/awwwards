        ...
        <div>
          ...
          {isComingSoon && (
            <div
              ...
              onMouseLeave={handleMouseLeave}
              className="border-hsla relative w-fit flex items-center cursor-pointer gap-1 overflow-hidden rounded-full bg-black px-5 py-2 text-xs uppercase text-white/20"
            >
              <div
